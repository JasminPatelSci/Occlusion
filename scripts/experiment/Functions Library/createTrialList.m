function [TrialList] = createTrialList(localizerTrials, singlePresentationTrials, proportionSequenceSingles)
...
motionDirection = repelem([0 1],1,proportionSequenceSingles*singlePresentationTrials/2);
...
TrialList50 = TrialList50(randperm(size(TrialList50,1)),1);
