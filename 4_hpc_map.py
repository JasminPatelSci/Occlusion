...
Cross-decoding of localiser->motion/visibility events for occlusion experiment. 
...
import os 
import mne
from efuncsnB import epoch_motion
...
def run_decoding(x, file):
    ...
    #run LDA
    xmin = 38 #update to required min sampling point per timewindow
    xmax = 77 #update to required min sampling point per timewindow
